    ...
    {{
        ...
        "structure": [
            ...
            {{
                ...
                "description": "주요 소비자 그룹의 최신 선호도와 행동 패턴 변화를 분석하여 핵심 트렌드를 도출합니다.",
                "content_type": "full_data_for_chart",
                "use_contents": [1, 5, 9],
                "is_sufficient": true,
                "feedback_for_gatherer": ""
            ...
            {{
                ...
                "feedback_for_gatherer": {{
                    ...
                    "query": "대한민국 만두 시장 주요 경쟁사별 시장 점유율 및 마케팅 전략"
                }}
            }},
            {{
            ...
            try:
                ...
                if previous_charts:
                    ...
                    for prev_chart in previous_charts[-2:]:  # 최근 2개만
                        ...
                        chart_labels = prev_chart.get("chart", {}).get("data", {}).get("labels", [])[:3]
