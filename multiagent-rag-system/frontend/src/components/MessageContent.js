...
const MessageContent = ({
  ...
  // 메시지별 데이터를 우선 사용 (전역 상태는 스트리밍 중일 때만)
  const messageFullDataDict = message.isStreaming 
    ? (fullDataDict || message.fullDataDict || {})
    : (message.fullDataDict || {});
    ...
    <div className="message-content-wrapper">
      ...
      {shouldShowPDFButton && (
        <PDFDownloadButton
          ...
          sources={sources}
          fullDataDict={messageFullDataDict}
