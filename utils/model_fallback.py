...
class ModelFallbackManager:
    ...
    GEMINI_KEY_1 = os.getenv("GEMINI_API_KEY_1", "your-gemini-api-key-1-here")
    GEMINI_KEY_2 = os.getenv("GEMINI_API_KEY_2", "your-gemini-api-key-2-here")
    ...
    @classmethod
    def create_fallback_model(cls, gemini_model: str = "gemini-1.5-flash", openai_model: str = "gpt-4o-mini", **kwargs):
        """
    ...
    def chat_completions_create_with_fallback(cls, model: str, messages: list, **kwargs) -> str:
        ...
        if model.startswith("gemini-"):
            ...
            gemini_model_map = {
                ...
                # 대용량 문서 처리 - 1.5 Pro (2M context)
                "gpt-4-long-context": "gemini-1.5-pro",
